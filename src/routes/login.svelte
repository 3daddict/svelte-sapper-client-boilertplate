...
<section class="md:pt-20 md:bg-gray-100 h-full">
  <div
    class="flex flex-col bg-white h-full md:h-auto md:w-440px md:mx-auto pt-12
    md:rounded md:overflow-hidden md:shadow-2">
    ...
    <div class="flex justify-center flex-1 items-end mb-4 md:hidden">
      <Button mode="link" classes="text-gray-300 text-xs mx-2" href="/terms">
        Terms
      </Button>
      <Button mode="link" classes="text-gray-300 text-xs mx-2" href="/privacy">
        Privacy
      </Button>
    </div>
  </div>
